...
const linkedin = (
  <svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18">
    <g clip-path="url(#clip0_3145_3039)">
      <path d="M18.4959 17.9992L18.5004 17.9984V11.3969C18.5004 8.16744 17.8052 5.67969 14.0297 5.67969C12.2147 5.67969 10.9967 6.67569 10.4994 7.61994H10.4469V5.98119H6.86719V17.9984H10.5947V12.0479C10.5947 10.4812 10.8917 8.96619 12.8319 8.96619C14.7437 8.96619 14.7722 10.7542 14.7722 12.1484V17.9992H18.4959Z" />
      <path d="M0.796875 5.98242H4.52888V17.9997H0.796875V5.98242Z" />
      <path d="M2.6615 0C1.46825 0 0.5 0.96825 0.5 2.1615C0.5 3.35475 1.46825 4.34325 2.6615 4.34325C3.85475 4.34325 4.823 3.35475 4.823 2.1615C4.82225 0.96825 3.854 0 2.6615 0Z" />
    </g>
    <defs>
...
const facebook = (
  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
    <mask id="mask0_3145_4712" maskUnits="userSpaceOnUse" x="0" y="0" width="18" height="18">
      <path d="M17.668 0.5H0.667969V17.5H17.668V0.5Z" />
    </mask>
    <g>
      <path
